    ...
    {Arr.map((item) => (  
      ...
      >
        <CardContent sx={{ alignItems: 'center', textAlign: 'center' }}>
          ...
          >
            <IconButton size="sm" variant="plain" style={{
              color:"#d9e3ea"
            }}>
              {/* <SvgIcon> */}
                <svg
        ...
        <CardOverflow sx={{ bgcolor: 'background.level1' }} style={{  backgroundColor:"#25282C"}}>
          <CardActions buttonFlex="1">
            <ButtonGroup variant="outlined" >
              <Button style={{color:"white",margin:"5px"}}>Message</Button>
              <Button style={{color:"white",margin:"5px"}}>Connect</Button>
            </ButtonGroup>
          </CardActions>
        </CardOverflow>
      </Card>
